        ...
        form.addEventListener('submit', (event) => {
            ...
            xhr.onreadystatechange = function() {
                if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
                    ...
                    <a href="{{ url_for('recipe', recipe=${recipeId}, title=comment.title|resub)}}">${recipeTitle}</a></div><ul class="uk-comment-meta uk-subnav uk-subnav-divider uk-margin-remove-top">
